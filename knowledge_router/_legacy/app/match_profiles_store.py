...
from .models_store import MASK, ModelSlotConfig, ModelsStore, parse_enable_thinking
        ...
        for row in rows if isinstance(rows, list) else []:
            ...
            self._profiles.append(
                MatchProfile(
                    ...
                    enable_thinking=parse_enable_thinking(row.get("enable_thinking")),
                )
            )
            ...
            if isinstance(rows, list):
                ...
                for row in rows:
                    ...
                    if key_in is not None:
                        ...
                        if k != MASK:
                            new_key = k
                    enable_thinking = old.enable_thinking if old else None
