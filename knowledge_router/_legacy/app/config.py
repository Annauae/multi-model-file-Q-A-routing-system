...
class Settings:
    ...
    debug_request_timeout_s: int  # 调试问答 SSE 超时（秒），超时后重启服务
    ...
    def load() -> "Settings":
        ...
        debug_request_timeout_s = max(1, int(os.getenv("DEBUG_REQUEST_TIMEOUT_S", "60")))
        ...
        return Settings(
            ...
            debug_request_timeout_s=debug_request_timeout_s,
        )
